...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="relative py-24 sm:py-32 bg-black text-white px-4 sm:px-6"
    >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16"
      >
        {/* LEFT */}
        <div className="text-center md:text-left">
          ...
          <p className="text-gray-300 mb-8 sm:mb-10">
            Want to discuss data projects, analytics, or machine learning ideas?
            Drop a message and let’s build something impactful.
          </p>

          <div className="border border-gray-700/60 rounded-2xl p-6 sm:p-10 backdrop-blur-sm hover:border-blue-400 transition">
            <div className="text-2xl sm:text-4xl md:text-5xl mb-4 text-gray-400">
              💡 Every spark leads to transformation
            </div>
          </div>
        </div>
        ...
        <form
          ref={formRef}
          onSubmit={sendEmail}
          className="bg-slate-900/70 border border-gray-700/60 rounded-2xl p-6 sm:p-8 backdrop-blur-sm shadow-lg"
        >
          <input
            name="user_name"
